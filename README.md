...
./.venv/Scripts/python -m pytest tests/ -v   # 814 tests
...
All reachable from the UI: an explicit **Save**, per-format download buttons, a **Sheets** panel for page setup/title blocks/PDF export, and (2D) an **Import SVG/DXF** picker that broadcasts the imported paths to everyone in the room.
